    ...
    <div class="col-lg-9">
        <div class="card">
            <div class="card-header">
                <strong>Edit Sayuran</strong>
            </div>
            <div class="card-body card-block">
                <?php echo form_open_multipart('Penjual/Sayuran/edit'); 
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" value="<?php  echo $produk['nama_produk'] ?>"  name="nama_produk" placeholder="Masukan nama Sayuran" class="form-control">
