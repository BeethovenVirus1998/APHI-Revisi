    ...
    <div class="container">				
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav"><a href="<?php echo site_url('Welcome') ?>">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="<?php echo site_url('Padi') ?>">Padi</a></p>
            </div>	
        </div>
    </div>
</section>
                ...
                <div class="col-lg-4 cl-md-6">
                    <div class="single-training">
                        <div class="thumb relative">
                            ...
                            <a  class="admission-btn btn btn-default fa fa-cart-plus" href="<?php echo site_url('Padi/pesan/'.$p->id_produk) ?>"></a>
                        </div>
                        <div class="details">
