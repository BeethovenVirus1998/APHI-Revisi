...
Class UserSayuran extends CI_Controller {
    ...
    function index() {
        $config['base_url'] = site_url('UserSayuran/index');
        ...
        $data['produk'] = $this->db->get_where('produk', array('jenis' => 'sayuran', 'status' => 1))->result();
        $this->template->load('Penjual/template','usersayuran', $data);
    }
