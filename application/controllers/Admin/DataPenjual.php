...
Class DataPenjual extends CI_Controller {
    ...
    function index() {
        ...
        $this->template->load('admin/template', 'Admin/data_penjual/detail', $data);
       ...
       function nonaktif() {
        ...
        $this->session->set_flashdata('hapus', 'Sukses menonaktifkan akun');
