...
Class UserPadi extends CI_Controller {
    ...
    function index() {
        $config['base_url'] = site_url('UserPadi/index');
        ...
        $data['produk'] = $this->db->get_where('produk', array('jenis' => 'padi', 'status' => 1))->result();
        $this->template->load('Penjual/template','userpadi', $data);
    }
