...
Class UserBuah extends CI_Controller {
    ...
    function index() {
        $config['base_url'] = site_url('UserBuah/index');
        ...
        $data['produk'] = $this->db->get_where('produk', array('jenis' => 'buah', 'status' => 1))->result();
        $this->template->load('Penjual/template','userbuah', $data);
    }
